...
> = {
  en: {
    ...
    answerModes: {
      solfege: "Solfege (Do Re Mi Fa So La Ti)",
      letter: "Letter names (C D E F G A B)",
      number: "Numbered notation (1 2 3 4 5 6 7)",
  ...
  zh: {
    ...
    answerMode: "答题模式",
    answerModes: {
      solfege: "唱名（Do Re Mi Fa So La Ti）",
      letter: "音名（C D E F G A B）",
      number: "简谱（1 2 3 4 5 6 7）",
      piano: "钢琴按键",
    },
    correct: "答对了！",
    incorrect: "再想想。",
